...
ll solve(){
    ...
    if(flag2 == true && flag3 == true && in1 < in2) return -1;
    if(flag2 == true && flag1 == true && in1 < in4) return -1;
    if(flag3 == true && flag1 == true && in3 < in2) return -1;
    if(in3 < in4) return -1;
    if(s[0] == '>' || s[0] == '*') return n;
    else{
        ll cnt1 = 0,cnt2 = 0;
        ...
        if(flag1 == true){
            ll ans1 = max(cnt1 + 1,cnt2);
            ll ans2 =  max(cnt1,cnt2 +1);
